...
class VeoProvider(VideoProvider):
    ...
    def _pick_best_image(self, input_dir: str) -> Path | None:
        """Pick the largest image file from the input directory as the hero frame."""
        images = []
    ...
    def _find_reference_image(self, input_dir: str, outputs_dir: str) -> str | None:
        """Find the best reference image — prefer input photos, fall back to
        reconstruction outputs."""
        if input_dir:
            hero = self._pick_best_image(input_dir)
            if hero:
                return str(hero)
    ...
    def make_walkthrough(
        ...
        *,
        ...
        try:
            ...
            ref_image = self._find_reference_image(input_dir, outputs_dir)
            if ref_image:
            ...
            with httpx.Client(timeout=120) as client:
                ...
                mp4_path = out / f"{job_id}_walkthrough_veo.mp4"
            ...
            return ProviderResult(
                ...
                cost_usd=settings.cost_per_veo_generation,
            )
